  ...
  return (
    <section className={`popup ${name} ${isOpen ? "popup_opened" : ""}`}>
      <div className="popup__container">
        ...
        <form name={`${name}-form`} action="#" className="popup__form" onSubmit={onSubmit} noValidate>
          {children}
          <button type="submit" className="popup__save-button link-opacity save-profile">
            {buttonText}
          </button>
        </form>
      </div>
